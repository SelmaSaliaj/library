...
import com.project.domain.exception.GenericException;
...
public class BookReservationServiceImpl implements BookReservationService {
    ...
    public void save(BookReservationDTO request) {
        ...
        if(copies<=0){
            throw new GenericException("You can not reserve the book. No copies available");
        }

        PhysicalCopyDTO book = request.getBook();
        book.setNumberOfCopiesAvailable(copies-1);
