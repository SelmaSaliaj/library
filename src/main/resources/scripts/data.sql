...
INSERT INTO user
VALUES (1,"Ana Bekteshi","$2a$10$i8lUYAMiTs2vfdBOk.Q5vuI1RtpYcN4V4deZ9lORCm3HDmAe.ULd2","USER"),
       (2,"Emiraldo Cakaj","$2a$10$i7lUYAMiTs2vfdBOk.Q5vuI1RtpYcN4V4deZ2lORCm3HDmAe.ULd2","USER"),
       (3,"Enkeleda Kalliri","$3a$10$i6lUYAMiTs2vfdBOk.Q2vuI1RtpYcN4V4deZ9lORCm3HDmAe.ULd2","USER"),
       (4,"Klaudja Hoxha","$2a$10$i9lUYAMiTs2vfdBOk.Q5vuI1RtpYcN6V4deZ9lORCm3HDmAe.ULd2","USER"),
       (5,"Eraldo Hoxha","$3a$12$i7lUYAMiTs2vfdBOk.Q5vuI1RtpYcN4V4deZ9lORCm3HDmAe.ULd2","USER"),
       (6,"Serxho Gjoni","$2a$20$i7lUYAMiTs2vfdBOk.Q5vuI1RtpYcN5V4deZ9lORCm3HDmAe.ULd2","USER"),
       (7,"Rosilda Agolli","$2a$10$i3lUYAMiTs2vfdBOk.Q5vuI1RtpYcN7V4deZ9lORCm3HDmAe.ULd2","USER"),
       (8,"Leonardo Mezini","$5a$10$i8lUYAMiTs2vfdBOk.Q4vuI1RtpYcN4V4deZ9lORCm3HDmAe.ULd2","ADMIN"),
       (9,"Antonela Malaj","$5a$10$i8lUYAMiTs3vfdBOk.Q4vuI1RtpYcN4V4deZ9lORCm3HDmAe.ULd2","ADMIN");

INSERT INTO reader(id, deleted, name, surname, email, address, phone_number, user_id)
VALUES (1, false, "Ana", "Bekteshi", "anabekteshi@gmail.com","Rruga 'Sami Frasheri'","0692732511",1),
       (2, false, "Emiraldo", "Cakaj", "emiraldocakaj@gmail.com","Rruga 'Qemal Stafa'","0672261543",2),
       (3, false, "Enkeleda", "Kalliri", "enkeledakalliri@gmail.com","Rruga 'Tasin Tafaj'","068321469",3),
       (4, false, "Klaudja", "Hoxha", "klaudjahoxha@gmail.com","Rruga 'Marie Logoreci'","0692772422",4),
       (5, false, "Eraldo", "Hoxha", "eraldohoxha@gmail.com","Rruga 'Marie Logoreci'","0684059319",5),
       (6, false, "Serxho", "Gjoni","serxhogjoni@gmail.com","Rruga 'Qemal Stafa'","0673162511",6),
       (7, false, "Rosilda", "Agolli", "rosildaagolli@gmail.com","Rruga 'Sami Frasheri'","0694077402",7);

INSERT INTO reservation(id, create_date, last_modified, deleted, reader_id)
